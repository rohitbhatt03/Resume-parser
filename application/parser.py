...
"""
    ...
    def query_completion(self: object,
        ...
        """
        Base function for querying GPT-4. 
        Send a request to GPT-4 with the passed-in function parameters and return the response object.
        :param prompt: GPT-4 completion prompt.
    ...
    def query_resume(self: object, pdf_path: str) -> dict:
        """
        Query GPT-4 for the work experience and / or basic information from the resume at the PDF file path.
        :param pdf_path: Path to the PDF file.
